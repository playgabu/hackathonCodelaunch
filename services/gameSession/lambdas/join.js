...
export const handler = async (event) => {
	...
	await GameSessionModel.addChild(event.pathParameters.id, sessionChild.childId)
	await ChildModel.setGameSession(sessionChild.childId, event.pathParameters.id)
